local function loadSharkPlanner()
  ...
  local function updateWayPointUIState()
    ...
    transferButton:setEnabled((#wayPoints > 0 or #fixPoints > 0 or #targets > 0) and transferIsInactive())
    if waypointToggle:getState() then
